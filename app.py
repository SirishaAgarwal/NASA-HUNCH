...
def signup():
    username = request.form.get("username")
    password = request.form.get("password")
    role = request.form.get("role", "crew")

    if role not in ("admin", "crew"):
        role = "crew"
...
def inventory():
    if request.method == "POST" and current_user.role != "admin":
        flash("Admin access required to modify inventory.")
...
# ---------------- PERSONAL MEDICAL PAGE ---------------- #
@app.route("/medical")
@login_required
def medical():
    return render_template("medical.html")

@app.route("/medical/elena")
@login_required
def medical_elena():
    return render_template("medical_elena.html")

@app.route("/medical/marcus")
@login_required
def medical_marcus():
    return render_template("medical_marcus.html")

@app.route("/medical/aisha")
@login_required
def medical_aisha():
    return render_template("medical_aisha.html")
# ---------------- BARCODE SCANNER ---------------- #
